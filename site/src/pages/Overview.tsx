  ...
  return (
    <>
      ...
      >
        ...
        <Box component="span" sx={{ fontFamily: fonts.mono }}>comment</Box>. Cross-record links use{" "}
        <Box component="span" sx={{ fontFamily: fonts.mono }}>com.atproto.repo.strongRef</Box> where the
        exact version matters, and a bare{" "}
        <Box component="span" sx={{ fontFamily: fonts.mono }}>at-uri</Box> where it does not.
      </Box>
